...
# from omni.isaac.orbit_tasks.deformable.reshape.mdp import mdp
import omni.isaac.orbit_tasks.deformable.reshape.mdp as mdp
from omni.isaac.orbit_tasks.deformable.reshape.reshape_env_cfg import ReshapeEnvCfg
...
@configclass
class FrankaOringReshapeEnvCfg(ReshapeEnvCfg):
...
@configclass
class FrankaOringReshapeEnvCfg_PLAY(FrankaOringReshapeEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
