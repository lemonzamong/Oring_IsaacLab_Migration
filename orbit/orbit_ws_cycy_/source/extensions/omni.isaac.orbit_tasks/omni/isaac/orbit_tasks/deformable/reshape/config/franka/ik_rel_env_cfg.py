...
from omni.isaac.orbit_assets.franka_reshape import FRANKA_PANDA_HIGH_PD_CFG  # isort: skip


@configclass
class FrankaOringReshapeEnvCfg(joint_pos_env_cfg.FrankaOringReshapeEnvCfg):
