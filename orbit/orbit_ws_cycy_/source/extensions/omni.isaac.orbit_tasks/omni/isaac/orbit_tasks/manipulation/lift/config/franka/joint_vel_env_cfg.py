...
from omni.isaac.orbit_tasks.manipulation.lift.vision_lift_env_cfg import LiftEnvCfg as VisionLiftEnvCfg
...
class FrankaCubeLiftEnvCfg(LiftEnvCfg):
    def __post_init__(self):
        ...
        self.actions.body_joint = mdp.JointVelocityActionCfg(
            asset_name="robot", joint_names=["panda_joint.*"], scale=0.5, use_default_offset=True
        )
        self.actions.finger_joint = mdp.BinaryJointPositionActionCfg(
            asset_name="robot",
...
@configclass
class FrankaCubeVisionLiftEnvCfg(VisionLiftEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
