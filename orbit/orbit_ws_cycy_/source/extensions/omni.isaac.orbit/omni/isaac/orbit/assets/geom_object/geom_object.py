...
from .geom_object_data import GeometryObjectData

if TYPE_CHECKING:
    from .geom_object_cfg import GeometryObjectCfg


class GeometryObject(AssetBase):
    ...
    cfg: GeometryObjectCfg
    """Configuration instance for the rigid object."""

    def __init__(self, cfg: GeometryObjectCfg):
    ...
    @property
    def data(self) -> GeometryObjectData:
        return self._data
