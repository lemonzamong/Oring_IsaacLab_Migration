...
@configclass
class PseudoInverseJacobianActionCfg(ActionTermCfg):
    """Configuration for inverse differential kinematics action term.

    See :class:`PseudoInverseJacobianAction` for more details.
    """
    ...
    class_type: type[ActionTerm] = task_space_actions.PseudoInverseJacobianAction
