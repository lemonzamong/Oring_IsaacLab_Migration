...
class RLDOTaskEnv(BaseEnv, gym.Env):
    ...
    def _reset_idx(self, env_ids: Sequence[int]):
        ...
        if "pre_reset" in self.randomization_manager.available_modes:
            self.randomization_manager.randomize(env_ids=env_ids, mode="pre_reset")
        self.sim.step(render=False)
        ...
        if "post_reset" in self.randomization_manager.available_modes:
            self.randomization_manager.randomize(env_ids=env_ids, mode="post_reset")
