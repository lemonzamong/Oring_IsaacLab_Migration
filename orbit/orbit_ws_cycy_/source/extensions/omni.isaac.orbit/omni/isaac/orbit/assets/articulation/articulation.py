...
class Articulation(RigidObject):
    ...
    # @root_physx_view.setter
    # def root_physx_view(self, value) -> physx.ArticulationView:
    #     self._root_physx_view = value

    # @body_physx_view.setter
    # def body_physx_view(self, value) -> physx.RigidBodyView:
    #     self._body_physx_view = value

    @property
    def joint_indices(self):
        return self.root_physx_view.shared_metatype.dof_indices
    ...
    def write_data_to_sim(self):
        ...
        if self._has_implicit_actuators:
            # if self.cfg.rl_control_type =="vel":
    ...
    def write_target_joint_state_to_sim(self):
    ...
    def write_joint_velocity_to_sim(self):
        """ controller function for disentangle franka agent"""
        self._apply_actuator_model()
        # apply actions into simulation
        self.root_physx_view.set_dof_actuation_forces(self._joint_effort_target_sim, self._ALL_INDICES)
        # position and velocity targets only for implicit actuators
        self._joint_pos_target_sim = self._data.joint_pos
        self._joint_pos_target_sim[:, 3:5] = 0. # fix rev_x, rev_y joint
        # set velocity, position targets
        self.root_physx_view.set_dof_position_targets(self._joint_pos_target_sim, self._ALL_INDICES)
        self.root_physx_view.set_dof_velocity_targets(self._joint_vel_target_sim, self._ALL_INDICES)
    ...
    #     self._re_initialize_impl()       
    #     # self.__init__(self.cfg)
         

    # def _re_initialize_impl(self):
    #     self.__init__(self.cfg)
    ...
    #     # -- link views
    #     self.root_physx_view = self._root_physx_view
    ...
    #     physx_body_names = self._root_physx_view.shared_metatype.link_names
    ...
    #     # self.body_physx_view(self._body_physx_view)
    #     self.body_physx_view = self._body_physx_view
