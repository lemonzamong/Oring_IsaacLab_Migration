...
def define_sensor() -> Camera:
    ...
    camera_cfg = CameraCfg(
        ...
        spawn=sim_utils.PinholeCameraCfg(
            ...
            focal_length=24.0, focus_distance=400.0, horizontal_aperture=20.955, clipping_range=(0.1, 6.)
        ),
...
def design_scene():
    ...
    for i in range(2):
        ...
        _ = prim_utils.create_prim(
            usd_path = f"{LOCAL_ASSETS_DIR}/disentangle/train/oring_07_015.usd",
            prim_path = f"/World/Objects/Obj_{i:02d}",
            translation=position,
            semantic_label="oring",
        )
        # add soft properties
        soft_obj = DeformablePrim(f"/World/Objects/Obj_{i:02d}/mesh")
        
        # # cast to geom prim
        # geom_prim = getattr(UsdGeom, "oring")(soft_obj.prim)
